        ...
        {blocks.map((b, i) => (
          ...
          >
            ...
            <div className="w-full lg:w-[58%] xl:w-[55%] shrink-0">
              <div className="relative w-full min-h-[min(92vw,420px)] sm:min-h-[300px] md:min-h-[380px] lg:min-h-[420px] rounded-2xl overflow-hidden bg-gradient-to-br from-navy/[0.06] to-white shadow-xl ring-1 ring-navy/10">
