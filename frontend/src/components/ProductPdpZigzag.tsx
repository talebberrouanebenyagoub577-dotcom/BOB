...
export function ProductPdpZigzag({ title, ariaLabel, blocks }: Props) {
  return (
    <section
        ...
        {blocks.map((b, i) => (
          ...
          >
            ...
            <div className="w-full lg:w-[58%] xl:w-[55%] shrink-0">
              <div className="relative w-full min-h-[220px] sm:min-h-[280px] md:min-h-[380px] lg:min-h-[420px] rounded-2xl overflow-hidden bg-gradient-to-br from-navy/[0.06] to-white shadow-xl ring-1 ring-navy/10">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={b.imageSrc}
                  alt={b.title}
                  className="absolute inset-0 h-full w-full object-contain p-5 sm:p-7 md:p-10"
